		...
		<form name="addPurchase" method="post" action="/addPurchase.do"> 
			...
			<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
				...
				<tr>
					...
					<td bgcolor="D6D6D6" width="1"></td>
					<td class="ct_write01"><%= pvo.getManuDay() %></td>
				</tr>
				<tr>
					<td height="1" colspan="3" bgcolor="D6D6D6"></td>
				</tr>
				...
				<tr>
					...
					<td class="ct_write01">
						<input type="text" name="receiverName" 	class="ct_input_g" 
									style="width: 100px; height: 19px" maxLength="20" value="" placeholder="이름을입력하세요"/>
					</td>
				</tr>
				<tr>
					<td height="1" colspan="3" bgcolor="D6D6D6"></td>
				...
				<tr>
					...
					<td class="ct_write01">
						<input 	type="text" name="receiverPhone" class="ct_input_g" 
										style="width: 100px; height: 19px" maxLength="20" value="" placeholder="연락처를입력하세요"/>
					</td>
				</tr>
				<tr>
					<td height="1" colspan="3" bgcolor="D6D6D6"></td>
				...
				<tr>
					...
					<td class="ct_write01">
						<input 	type="text" name="receiverAddr" class="ct_input_g" 
										style="width: 100px; height: 19px" maxLength="20" value="" placeholder="주소를입력하세요"/>
					</td>
				</tr>
				<tr>
					<td height="1" colspan="3" bgcolor="D6D6D6"></td>
