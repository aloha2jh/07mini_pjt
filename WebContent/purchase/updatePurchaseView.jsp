			...
			<tr>
				...
				<td class="ct_write01"> 
					<select 	name="paymentOption" class="ct_input_g" style="width: 100px; height: 19px" maxLength="20">  
						<option value="0" ${ !empty psvo.paymentOption  && fn:trim(psvo.paymentOption)==0 ? "selected" :"" } >현금구매</option>
						<option value="1" ${ !empty psvo.paymentOption  && fn:trim(psvo.paymentOption)==1 ? "selected" : "" } >신용구매</option>  
					</select>     
				</td>
			</tr>
			<tr>
